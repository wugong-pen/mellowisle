...
import {methods,bankConfig,lineSignature,parseLine,validRedirect,paypalPaid,start} from './payments.js';
...
test('PayPal paid requires completed capture, order, and TWD amount',()=>{
 const order={order_number:'WG1',total:25000},result={id:'P1',status:'COMPLETED',purchase_units:[{reference_id:'WG1',custom_id:'WG1',payments:{captures:[{status:'COMPLETED',amount:{currency_code:'TWD',value:'25000'},final_capture:true}]}}]};
